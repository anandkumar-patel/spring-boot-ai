...
class ChatController {
    ...
    ChatController(ChatClient.Builder builder,
                   @Value("classpath:/prompts/test-question-message.st")
    ...
    @PostMapping("/api/gen-question")
    Output generateTestProgram(@RequestBody @Valid Input input) throws IOException {
